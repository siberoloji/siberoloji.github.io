...
Metasploitable3, Github adresinden dağıtılıyor. [Metasploitable3 Github Sayfası](https://github.com/rapid7/metasploitable3)

Metasploitable3 üzerinde bulunan zafiyetler
Aşağıdaki listede şu an için mevcut bulunan zafiyetleri görebilirsiniz. Projenin Wiki sayfasına zaman içinde yeni servisler ve zafiyetler yükleneceği belirtiliyor.
...
Şimdi birlikte packer programını kuralım. Bu adresten [Packer İndirme Bağlantısı](https://www.packer.io/downloads.html) Linux İşletim sisteminize uygun olan .zip uzantılı dosyayı indirin.
...
Vagrant programı, .deb uzantılı dağıtılmaktadır. [Bu adresten](https://www.vagrantup.com/downloads.html) Debian tabanlı kurulum dosyasını bilgisayar mimarinize göre 64 bit – 32 bit olarak seçin ve indirin.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PL2Q2UedYW5s3QR2tPNGt2s-NP19Hg6tLN" frameborder="0" allowfullscreen></iframe>