...
<p>systemd hakkında <a href="http://www.siberoloji.com/haberler/systemd-nedir-genel-yapisi-nasil-calisir/" target="_blank">giriş</a> yazısında, kısaca açıklayıcı bilgi vermeye çalışmıştık. Bu yazıda ise systemd, kullanıcılara hangi  araçları sunuyor? Bu araçların neler olduğunu açıklayacağız.</p>
