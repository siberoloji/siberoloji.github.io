...
<!-- /wp:code -->
  ...
  In the example above, a variable named <code>language</code> is defined and its value is assigned with <code>=</code> to <code>"Kotlin"</code> of type ***String*** . You should note that the <code>=</code> sign is used to assign the value. Now we can call this variable "language" while writing our codes in the program. 
