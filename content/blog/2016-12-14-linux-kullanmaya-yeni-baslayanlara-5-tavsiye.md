...
- right-sidebar
date: "2016-12-14T01:52:00Z"
excerpt: Son zamanlarda, Linux kullanmaya başlayanlara yardım etmeye çalışmak gibi
  bir hobiye kaptırdım kendimi. Bu çabalarım sayesinde, inanılmaz derecede yeni konular
  da öğrenme fırsatı bulduğumu belirtmeliyim. Kendi çabalarımla öğrenme çalışmalarım
  biraz yavaş ilerliyormuş meğer. Bir problemin çözümüne ihtiyacı olan kullanıcı,
  farkında olmadan yardım etmeye çalışanı motive ediyor aslında. Bunu keşfettim öncelikle.
  Empatinin farklı bir boyutunu yaşıyor insan. Bu yazıda, Linux Kullanmaya Yeni Başlayanlara
  Tavsiyeler derlemeye çalıştım. Henüz başlamamış olanlara da faydalı olacağına eminim.
guid: https://www.siberoloji.com/?p=1111
id: 1111
...
---
  ...
  Yaklaşık 2 ay, işletim sistemini hep CD den başlatıp kullandım. Bu süre zarfında komut satırından kaç kere help komutunu verdiğimi bilmiyorum. Halen help ve man komutunu kullanıyorum. Bir de üzerimde hatırı olduğundan, mutlaka yad etmek adına hexa-hop oyunu hastası haline geldiğimi burada belirtmeliyim.</p>
  ...
  Şimdi sıra geldi tavsiyelere;</p>
 

 
 ## 1. İşletim Sistemi Bir Araçtır:</h2>
<!-- /wp:heading -->
 ...
 ## 2. Komut Satırı ile barışık olmalısınız.</h2>
<!-- /wp:heading -->
  ...
  Ancak, komut satırından işlem yaptığınızda neredeyse tam olarak çözüm söylenir veya bir log dosyasını incelemeniz tavsiye edilir. Bu log dosyasını incelediğinizde hatanın nereden kaynaklandığını yaklaşık olarak bilirsiniz. Bu bilgi ile forumlarda yardım aradığınızda da size yardım etmek isteyenler yine komut satırından bir takım işlemler tavsiye ederler. İşte bu yüzden komut satırı ile barışık olmalısınız.</p>
 

 
 ## 3. İngilizce bilmek ve Türkçe kaynak problemi</h2>
<!-- /wp:heading -->
  ...
  Aşağıda iki örnek internet arama ifadesi veriyorum. Eminim sorunun çözümünü İngilizce olan kriterleri kullanarak daha çabuk bulacaksınız. Bu Türkçenin eksikliğinden değil kullanıcı sayısı ile ilgili bir durum. Bu sebeple biraz İngilizce bilmek gerekiyor.</p>
 

  Linux Mint 18 cario-dock nvidia crash problem</p>
 

  Linux Mint 18 cario-dock nvidia aniden kapanıyor</p>
 

 
 ## 4. Çalışıyorsa Kurcalamayın</h2>
<!-- /wp:heading -->
...
<!-- /wp:preformatted -->
  ...
  Son zamanlarda gördüğüm, “hocam şu komutları uyguladım ama işe yaramadı” söyleminin temelinde internette her bulunanı direk kopyala, yapıştırla sisteme uygulamak yatıyor. Hele bir de “permission denied” hatası alınınca başına sudo koyarak enter tuşuna basmak çözümü var.</p>
  ...
  -Uygulamaları, mümkün olduğunca dağıtımın paket deposundan yükleyin.</p>
 

  -Bulduğunuz bir çözümü uygulamadan önce, çözümün hangi dağıtım ve sürüm için yazıldığını mutlaka kontrol edin.</p>
 

  -Komut satırından akıp geçen yazılar, okumanız için akıp geçiyor. Okursanız çok faydalı olacaktır.</p>
 

 
 ## 5. Sormaktan çekinmeyin.</h2>
<!-- /wp:heading -->
  ...
  Bu temel tavsiyeler sanırım oldukça uzun oldu. Yazmaya başlarken bu kadar uzun olacağını tahmin etmemiştim. Bir başka yazıyla devam etmenin daha iyi olacağı düşüncesindeyim.</p>
