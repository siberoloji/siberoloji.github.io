...
- ***Hierarchy-Based Breadcrumbs*** : These show the site's structure and the user's current location within that hierarchy.<br>Example: Home &gt; Electronics &gt; Computers &gt; Laptops 
<!-- /wp:list-item -->

<!-- wp:list-item -->
- ***Attribute-Based Breadcrumbs*** : These display attributes of the current page or product.<br>Example: Home &gt; Laptops &gt; 15-inch &gt; Gaming &gt; Under $1000 
<!-- /wp:list-item -->

<!-- wp:list-item -->
- ***History-Based Breadcrumbs*** : These show the user's unique path through the website.<br>Example: Home &gt; Search Results &gt; Product Category &gt; Current Page 
<!-- /wp:list-item --> 
<!-- /wp:list -->
