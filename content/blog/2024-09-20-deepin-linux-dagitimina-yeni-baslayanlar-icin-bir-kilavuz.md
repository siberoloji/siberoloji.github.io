...
- ""
date: "2024-09-20T01:11:32Z"
guid: https://www.siberoloji.com/?p=1660
id: 1660
image: /assets/images/2024/09/deepinlinuxillustration1.webp
tags:
- deepin
- linux
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="cpp" class="language-cpp">sudo apt update &amp;&amp; sudo apt upgrade</code></pre>
<!-- /wp:code -->
...
<!-- wp:list -->
<ul class="wp-block-list"><!-- wp:list-item -->
- ***Sistemi güncelle*** &nbsp;:<code>sudo apt update &amp;&amp; sudo apt upgrade</code> 
<!-- /wp:list-item -->

<!-- wp:list-item -->
- ***Yazılımı yükleyin*** &nbsp;:<code>sudo apt install [package-name]</code> 
<!-- /wp:list-item -->

<!-- wp:list-item -->
- ***Disk kullanımını kontrol edin*** &nbsp;:<code>df -h</code> 
<!-- /wp:list-item -->

<!-- wp:list-item -->
- ***Bir dizindeki dosyaları listele*** &nbsp;:<code>ls</code> 
<!-- /wp:list-item --> 
<!-- /wp:list -->
