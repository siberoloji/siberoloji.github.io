...
<!-- wp:list -->
 <!-- wp:list-item -->
- If a variable name consists of a single word, it must be written in all lowercase letters. (<code>name</code>, <code>message</code>) 
<!-- /wp:list-item -->
...
<!-- wp:list-item -->
- You must give meaningful names to the variable. As a variable name, the <code>color</code> name will be more descriptive and meaningful than the <code>c</code> expression. 
<!-- /wp:list-item --> 
<!-- /wp:list -->
