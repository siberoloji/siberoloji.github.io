...
1.1. How to create a FreeBSD bootable USB drive on Windows/macOS/Linux.  
1.2. How to install FreeBSD in UEFI mode with Secure Boot.  
1.3. How to dual-boot FreeBSD with Windows using GRUB.  
